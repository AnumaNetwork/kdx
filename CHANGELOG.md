...
This is an interim release - due to changes in the Anuma project, the wallet framework functionality is currently disabled, instead you can use the "Console" tab to access the native Anuma CLI wallet.
